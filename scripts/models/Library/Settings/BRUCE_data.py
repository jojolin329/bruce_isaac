...
class BRUCE:
    ...
    def update_robot_status(self):
        ...
        estimation_data = get_data(self.data.estimator_state)
    ...
    def update_sense_status(self):
        ...
        sense_data = get_data(self.data.sense_state)
    ...
    def update_plan_status(self):
        ...
        plan_data = get_data(self.data.planner_command)
    ...
    def update_leg_status(self, torque=False):
        ...
        leg_data = get_data(self.data.leg_state)
    ...
    def set_command_leg_positions(self):
        ...
        update_block(self.data.leg_command, commands)
    ...
    def update_arm_status(self):
        ...
        arm_data = get_data(self.data.arm_state)
    ...
    def set_command_arm_positions(self):
        ...
        update_block(self.data.arm_command, commands)
    ...
    def get_time(self):
        if SIMULATION:
            ...
            sim_data = get_data(self.data.simulator_state)
    ...
    def stop_threading():
        ...
        # no a variable corresponding so the nameerror will occur cause the whole process stop
